...
import 'package:flutter_application_1/widgets/card-category.dart';
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .defaultButton), // Establece el color de fondo del botón
                      ...
                      padding: MaterialStateProperty.all(EdgeInsets.symmetric(
                          horizontal: 16.0, vertical: 12.0)), // Agrega padding
                    ),
                    onPressed: () {
                      // Responder al presionar el botón
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .primary), // Establece el color de fondo del botón
                      foregroundColor: MaterialStateProperty.all(
                          Colors.white), // Establece el color del texto
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(4.0),
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .info), // Establece el color de fondo del botón
                      foregroundColor: MaterialStateProperty.all(
                          Colors.white), // Establece el color del texto
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(4.0),
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .success), // Establece el color de fondo del botón
                      foregroundColor: MaterialStateProperty.all(
                          Colors.white), // Establece el color del texto
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(4.0),
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .warning), // Establece el color de fondo del botón
                      foregroundColor: MaterialStateProperty.all(
                          Colors.white), // Establece el color del texto
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(4.0),
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(MaterialColors
                          .error), // Establece el color de fondo del botón
                      foregroundColor: MaterialStateProperty.all(
                          Colors.white), // Establece el color del texto
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(4.0),
